...
const Home = () => {
  ...
  return (
      <div className="min-h-screen bg-[#1E1E1E] relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#1E1E1E] via-[#20232A] to-[#1E1E1E] animate-pulse-slow opacity-10 z-0" />
        ...
        <motion.header
            ...
            className="bg-[#2C2F33]/50 border-b border-[#24C3B5] backdrop-blur-sm z-10 relative"
        >
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            >
              <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }}>
                <Button size="lg" onClick={() => navigate('/register')} className="bg-[#24C3B5] hover:bg-[#3ED6C8] text-lg px-8 py-3 text-white">
                  Começar Agora
                </Button>
              </motion.div>
              <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }}>
                <Button size="lg" variant="outline" onClick={() => navigate('/login')} className="border-[#24C3B5] text-[#24C3B5] hover:bg-[#24C3B5]/10 text-lg px-8 py-3">
                  Já tenho conta
                </Button>
              </motion.div>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                  <motion.div
                      ...
                      viewport={{ once: true }}
                  >
                    <Card className="bg-[#1E1E1E] border-[#24C3B5]/20 hover:border-[#24C3B5]/40 hover:shadow-lg hover:bg-[#1F1F1F] transition-all duration-300 hover:scale-105">
        ...
        >
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              {[
                { value: 10000, suffix: '+', label: 'Traders Ativos', color: 'text-[#24C3B5]' },
                { value: 2.5, suffix: 'B', label: 'Volume Negociado', color: 'text-[#3ED6C8]' },
                { value: 99.9, suffix: '%', label: 'Uptime', color: 'text-[#A9B1B8]' },
