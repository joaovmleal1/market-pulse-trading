    ...
    return (
        <div className="min-h-screen font-inter">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
                    <div className="slide-up">
                        ...
                        <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
                            Negocie criptomoedas e dólar com tecnologia de ponta, análises avançadas e segurança total.
                            Comece sua jornada no trading hoje mesmo.
                        </p>
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
                            <Button variant="default" size="lg" className="group" onClick={() => navigate('/register')}>
                                Começar a Negociar
            ...
            <section id="stats" className="py-20 px-6 bg-card/50">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-bold text-foreground mb-4">Números que Impressionam</h2>
                        <p className="text-xl text-muted-foreground">Mais de 50.000 traders confiam na nossa plataforma diariamente</p>
                    </div>
            ...
            <section id="features" className="py-20 px-6">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-bold text-foreground mb-4">Tecnologia de Ponta para Seus Investimentos</h2>
            ...
            <section className="py-20 px-6 gradient-hero">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-4xl font-bold text-foreground mb-6">Pronto para Começar a Negociar?</h2>
                    <p className="text-xl text-muted-foreground mb-8">
                        Junte-se a milhares de traders que já transformaram suas vidas com nossa plataforma.
                    </p>
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <Button variant="default" size="lg" className="group pulse-glow" onClick={() => navigate('/register')}>
            ...
            <footer id="contact" className="py-12 px-6 border-t border-border/50">
                <div className="max-w-7xl mx-auto">
