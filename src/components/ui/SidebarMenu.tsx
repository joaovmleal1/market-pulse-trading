...
import { User, LogOut, Clock, BarChart3, Shield, HelpCircle } from 'lucide-react';
...
const SidebarMenu = () => {
    ...
    return (
        <aside className="fixed top-4 left-4 w-64 max-w-[90vw] bg-[#111827] p-6 rounded-2xl shadow-xl border border-cyan-500/20 z-50 text-sm">
